      ...
      {!data ? (
        ...
        <div className="flex items-center overflow-y-auto w-fit h-fit">
          <div className="overflow-y-auto p-4 md:p-9 mt-5 mx-auto md:w-3/4 lg:w-2/3 xl:w-1/2">
            <div className="p-1 sm:p-4 md:p-9 ring-2 ring-[#3b82f6] rounded-lg mt-5 h-fit">
              {data.map((post, index) => (
                <div key={index}>
                  <div className="rounded-lg mb-3 sm:px-3 sm:mx-3 ">
                    <div className="card py-3 px-2 rounded-lg bg-[#] flex flex-col items-center">
                      ...
                      <hr />
                      <div className="flex">
                        <h2 className="rounded-lg py-3 px-3 ring-2 ring-[#3b82f6]  dark:text-white text-md md:text-lg mt-5">
                          {post.text}
